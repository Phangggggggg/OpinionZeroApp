...
class _EditProfileState extends State<EditProfile> {
  ...
  Widget build(BuildContext context) {
    return Column(children: [
      AboutYouWidget(title: 'Username', icon: Icons.person_rounded, actualUser: userInfos[1],iconColor: kDarkBlue,),
      AboutYouWidget(title: 'Email', icon: Icons.email_rounded, actualUser: userInfos[2],iconColor: kLightBlue,),
